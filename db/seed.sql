...
-- ── Digital-insurtech style products ─────────────────────────────
(24, 'Smart Home Basic', 'home', 18, 75, 1800, 3600, 'Home + belongings', 'Core protection for renters and apartment owners, including belongings, liability, accidental damage and travel cover.', 0, 'Coverage limits and deductibles apply; pre-existing damage is excluded.', 1),
(25, 'Smart Home Plus', 'home', 18, 75, 3000, 5400, 'Extended home protection', 'Broader home cover with higher limits for belongings and accidental damage, aimed at customers wanting stronger everyday protection.', 0, 'Coverage limits, deductibles and specified high-value-item limits apply.', 1),
(26, 'Flexible Car Standard', 'car', 18, 80, 4200, 9600, 'Vehicle protection', 'Flexible motor cover for everyday drivers, including traffic liability and optional damage-related protection depending on selected level.', 0, 'Vehicle eligibility, deductible and selected coverage level apply.', 1),
(27, 'Digital Pet Care', 'pet', 18, 80, 2400, 7200, 'Veterinary care', 'Pet insurance for dogs and cats with veterinary-care protection and digital-first support for common pet health issues.', 20, 'Pre-existing conditions, waiting periods and veterinary limits apply.', 1);
...
(6, '租屋或自有住宅優先檢查居家保障', 'home', '{"main_goal":"home"}', '若主要需求是住宅、個人物品與日常責任保障，優先比較居家保險方案', 6, 1),
(7, '有車族依使用情境比較車險', 'car', '{"main_goal":"car"}', '若主要需求是車輛風險，依預算與保障層級比較合適的車險方案', 6, 1),
(8, '飼主優先考慮獸醫費用風險', 'pet', '{"main_goal":"pet"}', '若使用者飼養犬貓並擔心獸醫費用，優先比較寵物醫療保障方案', 6, 1);
...
(6, '居家保險通常保障什麼？', '居家保險通常涵蓋個人物品、責任、火災或水損等住宅相關風險；實際保障依方案與條款而異。', 'home', 'general'),
(7, '車險有哪些常見保障層級？', '車險通常可分為基本責任保障與較完整的車損保障，不同方案的自負額與保障範圍會不同。', 'car', 'general'),
(8, '寵物保險主要保障什麼？', '寵物保險主要用於分擔犬貓因疾病或意外產生的獸醫費用，通常會有等待期、自負額與年度限額。', 'pet', 'general');
